...
import com.ouyanghj.spider.htmlparser.HtmlParser;

public class UrlFetcher {

	public static List<String> urlParse(List<String> imageUrl, final List<String> list) {
		// 首先对网页进行链接请求，拿到网页源码
		for (int i = 0; i < list.size(); i++) {
			String html = HtmlParser.request(list.get(i));
	...
	public static List<String> getImageUrl(final String html, final List<String> imageUrl) {
