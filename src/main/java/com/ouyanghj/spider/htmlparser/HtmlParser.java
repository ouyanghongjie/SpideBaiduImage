package com.ouyanghj.spider.htmlparser;
...
public class HtmlParser {
	...
	public static String request(final String url) {
		...
		httpGet.setHeader("Cookie",
		                "BDqhfp=dog%26%26NaN%26%260%26%261;"
		...
		httpGet.setHeader("User-Agent", "Mozilla/5.0 (X11; " + "Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) "
